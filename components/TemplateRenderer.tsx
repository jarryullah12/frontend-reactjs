...
const A4_TEMPLATE_OVERRIDES: Record<string, TemplateFitConfig> = {
  ...
  vision: {
    summaryMaxChars: 130,
    experienceMaxItems: 2,
    experienceDescriptionMaxChars: 70,
    experienceDescriptionMaxLines: 2,
    educationMaxItems: 2,
    educationDescriptionMaxChars: 45,
    skillsMaxItems: 5,
    languagesMaxItems: 1,
  },
  clarity: {
    summaryMaxChars: 285,
    experienceMaxItems: 3,
    experienceDescriptionMaxChars: 180,
  ...
  nimbus: {
    summaryMaxChars: 300,
    experienceMaxItems: 3,
    experienceDescriptionMaxChars: 195,
    experienceDescriptionMaxLines: 4,
    educationMaxItems: 3,
    educationDescriptionMaxChars: 90,
    skillsMaxItems: 12,
  ...
  spectrum: {
    summaryMaxChars: 140,
    experienceMaxItems: 2,
    experienceDescriptionMaxChars: 80,
    experienceDescriptionMaxLines: 2,
    educationMaxItems: 2,
