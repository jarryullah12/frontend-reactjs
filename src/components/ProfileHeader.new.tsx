...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
  ...
  const [profileDataState, setProfileData] = useState({
    ...
    email: profileData?.email || session.email || "example@gmail.com",
          ...
          <div className="mt-4 sm:mt-0 sm:ml-6 flex-1">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 mt-4 text-sm text-gray-500 dark:text-gray-400">
              ...
              <div className="flex items-center">
                ...
                {profileDataState.email}
                {session.email && profileDataState.email !== session.email && (
                  <span className="ml-2 text-xs text-blue-500">(Session: {session.email})</span>
                )}
              </div>
            </div>
          </div>
