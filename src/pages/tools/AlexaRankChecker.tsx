...
export function AlexaRankChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate an Alexa Rank check for the following URL. Provide a mock global and country rank. URL:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Alexa Rank Checker - OptiSEO Tools" description="Check the Alexa rank of a website." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Alexa Rank Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check the Alexa rank of a website.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['alexa-rank-checker'] || [
