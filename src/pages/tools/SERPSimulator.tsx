...
export function SERPSimulator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a Google SERP snippet for the following details. Show how it would look and provide tips for improvement. Details:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="SERP Simulator - OptiSEO Tools" description="Preview how your webpage will look in Google search results." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">SERP Simulator</h1>
            <p className="text-gray-600 dark:text-gray-400">Preview how your webpage will look in Google search results.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Title, URL, and Meta Description</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['serp-simulator'] || [
