...
export function SchemaGeneratorLocal() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate LocalBusiness Schema.org JSON-LD markup for the following business details. Input:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Schema Generator (Local Business) - OptiSEO Tools" description="Generate Local Business Schema markup." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Schema Generator (Local Business)</h1>
            <p className="text-gray-600 dark:text-gray-400">Generate Local Business Schema markup.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Business Details</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['schema-generator-local'] || [
