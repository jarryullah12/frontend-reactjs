...
export function HreflangTagGenerator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate HTML hreflang tags for the following URLs and language/region codes. Input:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Hreflang Tag Generator - OptiSEO Tools" description="Generate hreflang tags for multi-language websites." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Hreflang Tag Generator</h1>
            <p className="text-gray-600 dark:text-gray-400">Generate hreflang tags for multi-language websites.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">URLs and Language/Region Codes</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['hreflang-tag-generator'] || [
