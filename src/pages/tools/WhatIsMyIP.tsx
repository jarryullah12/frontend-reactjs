...
export function WhatIsMyIP() {
    ...
    try {
      ...
      try {
        ...
        data = {
          ...
          region: result.region,
          country_name: result.country,
          org: result.connection?.isp || result.connection?.org
        };
      }
      setIpData(data);
    } catch (err: any) {
  ...
  return (
    <>
      <SEO title="What Is My IP - OptiSEO Tools" description="Find out your public IP address and location details." />
      ...
      <ToolDescription points={toolDescriptions['what-is-my-ip']} />
    </div>
    </>
  );
}
