...
export function RobotsTxtTester() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate testing the following URL against the provided robots.txt rules. Determine if it is allowed or disallowed. Input:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Robots.txt Tester - OptiSEO Tools" description="Test your robots.txt file for errors." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Robots.txt Tester</h1>
            <p className="text-gray-600 dark:text-gray-400">Test your robots.txt file for errors.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Robots.txt Content and URL to Test</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['robots-txt-tester'] || [
