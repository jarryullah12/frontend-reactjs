...
export function RedirectChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a redirect chain check for the following URL. Show a mock 301/302 redirect path. URL:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Redirect Checker - OptiSEO Tools" description="Check URL redirects and status codes." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Redirect Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check URL redirects and status codes.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['redirect-checker'] || [
