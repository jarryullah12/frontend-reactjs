...
export function KeywordTypoGenerator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate common typos, misspellings, and keyboard slip variations for the following keyword. Keyword:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Keyword Typo Generator - OptiSEO Tools" description="Generate common misspellings for your keywords." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Keyword Typo Generator</h1>
            <p className="text-gray-600 dark:text-gray-400">Generate common misspellings for your keywords.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['keyword-typo-generator'] || [
