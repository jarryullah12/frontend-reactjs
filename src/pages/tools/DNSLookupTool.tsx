...
export function DNSLookupTool() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a DNS lookup for the following domain. Provide mock A, AAAA, MX, and TXT records. Domain:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="DNS Lookup Tool - OptiSEO Tools" description="Perform a DNS lookup for any domain." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">DNS Lookup Tool</h1>
            <p className="text-gray-600 dark:text-gray-400">Perform a DNS lookup for any domain.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['dns-lookup-tool'] || [
