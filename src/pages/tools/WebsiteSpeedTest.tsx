...
export function WebsiteSpeedTest() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Estimate the website speed performance for the following URL based on general knowledge of its infrastructure or typical web performance bottlenecks. Provide estimated metrics for Load Time, TTFB, and suggestions for improvement related to speed (e.g., caching, image optimization). Do NOT provide generic on-page SEO advice like "Add an H1 tag" or "Add a meta description". URL:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Website Speed Test - OptiSEO Tools" description="Test the loading speed of your website." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Website Speed Test</h1>
            <p className="text-gray-600 dark:text-gray-400">Test the loading speed of your website.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['website-speed-test'] || [
