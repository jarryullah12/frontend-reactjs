...
export function LinkValueCalculator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Estimate the SEO value of a backlink with the following details. Provide an estimated score from 1-100 and explain why based on the provided metrics (like DA, Traffic, etc.). Do NOT provide generic on-page SEO advice like "Add an H1 tag" or "Add a meta description". Focus strictly on the backlink value. Details:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Link Value Calculator - OptiSEO Tools" description="Calculate the estimated value of a backlink." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Link Value Calculator</h1>
            <p className="text-gray-600 dark:text-gray-400">Calculate the estimated value of a backlink.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Backlink Details</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['link-value-calculator'] || [
