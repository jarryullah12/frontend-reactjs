...
export function BingKeywordTool() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate a list of keywords optimized for Bing search engine for the following seed keyword. Keyword:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Bing Keyword Tool - OptiSEO Tools" description="Find keywords for Bing search engine." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Bing Keyword Tool</h1>
            <p className="text-gray-600 dark:text-gray-400">Find keywords for Bing search engine.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['bing-keyword-tool'] || [
