...
export function WHOISLookup() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a WHOIS lookup for the following domain. Provide mock registration, registrar, and expiry details. Domain:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="WHOIS Lookup - OptiSEO Tools" description="Find WHOIS information for a domain." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">WHOIS Lookup</h1>
            <p className="text-gray-600 dark:text-gray-400">Find WHOIS information for a domain.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['whois-lookup'] || [
