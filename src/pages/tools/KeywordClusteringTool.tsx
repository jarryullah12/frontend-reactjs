...
export function KeywordClusteringTool() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Cluster the following keywords based on search intent and semantic similarity. Provide the output as a formatted list or table. Keywords:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Keyword Clustering Tool - OptiSEO Tools" description="Group keywords into clusters based on search intent." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Keyword Clustering Tool</h1>
            <p className="text-gray-600 dark:text-gray-400">Group keywords into clusters based on search intent.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Keywords (one per line)</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['keyword-clustering-tool'] || [
