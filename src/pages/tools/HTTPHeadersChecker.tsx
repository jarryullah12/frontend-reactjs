...
export function HTTPHeadersChecker() {
  ...
  const handleAnalyze = () => {
    ...
    setLoading(true);
    setTimeout(() => {
      setResult({ url: input, server: 'nginx', contentType: 'text/html; charset=UTF-8', connection: 'keep-alive' });
      setLoading(false);
    }, 1500);
  };
  ...
  return (
    <>
      <SEO title="HTTP Headers Checker - OptiSEO Tools" description="Check HTTP headers returned by a server." />
      <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">HTTP Headers Checker</h1>
          <p className="text-gray-600 dark:text-gray-400">Check HTTP headers returned by a server.</p>
        </div>
      ...
      <ToolDescription points={toolDescriptions['http-headers-checker']} />
    </div>
    </>
  );
}
