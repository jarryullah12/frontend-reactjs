...
export function CssMinifier() {
  ...
  const handleDownloadPdf = () => {
    downloadTextAsPdf(output, 'minified.css.pdf');
  };

  return (
    <>
      <SEO title="Css Minifier - OptiSEO Tools" description="Use our free Css Minifier tool to optimize your website." />
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white flex items-center gap-2">
          ...
          {t('tool_page.minifier.css_title')}
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 flex flex-col">
          ...
          <textarea
            readOnly
            value={output}
            className="flex-1 w-full min-h-[300px] px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-black text-emerald-600 dark:text-emerald-400 font-mono text-sm"
      ...
      <ToolDescription points={toolDescriptions['css-minifier']} />
    </div>
    </>
  );
}
