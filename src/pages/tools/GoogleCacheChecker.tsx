...
export function GoogleCacheChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a Google Cache check for the following URL. Provide a mock cached date and time. URL:\n${input}`,
      });
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <ToolDescription points={toolDescriptions['google-cache-checker'] || [
