...
export function LSIKeywordGenerator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate a list of LSI (Latent Semantic Indexing) keywords for the following main keyword. Provide them in a comma-separated list and explain briefly how to use them. Keyword: ${input}`,
      });
  ...
  return (
    <>
      <SEO title="LSI Keyword Generator - OptiSEO Tools" description="Generate Latent Semantic Indexing (LSI) keywords." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">LSI Keyword Generator</h1>
            <p className="text-gray-600 dark:text-gray-400">Generate Latent Semantic Indexing (LSI) keywords.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Main Keyword</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['lsi-keyword-generator'] || [
