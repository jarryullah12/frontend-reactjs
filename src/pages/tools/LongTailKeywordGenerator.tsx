...
export function LongTailKeywordGenerator() {
  ...
  const handleAnalyze = () => {
    ...
    setLoading(true);
    setTimeout(() => {
      setResult({ seedKeyword: input, longTailKeywords: ['how to choose ' + input, 'what are the best ' + input, input + ' vs alternative'].join(', ') });
      setLoading(false);
    }, 1500);
  };
  ...
  return (
    <>
      <SEO title="Long Tail Keyword Generator - OptiSEO Tools" description="Generate long tail keywords easily." />
      <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Long Tail Keyword Generator</h1>
          <p className="text-gray-600 dark:text-gray-400">Generate long tail keywords easily.</p>
        </div>
      ...
      <ToolDescription points={toolDescriptions['long-tail-keyword-generator']} />
    </div>
    </>
  );
}
