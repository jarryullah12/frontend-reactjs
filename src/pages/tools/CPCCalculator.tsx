...
export function CPCCalculator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a CPC (Cost Per Click) check for the following keyword. Provide a mock average CPC and competition level. Keyword:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="CPC Calculator - OptiSEO Tools" description="Calculate Cost Per Click (CPC) for campaigns." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">CPC Calculator</h1>
            <p className="text-gray-600 dark:text-gray-400">Calculate Cost Per Click (CPC) for campaigns.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Keyword or Niche</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['cpc-calculator'] || [
