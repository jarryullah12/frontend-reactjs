...
export function MetaDescriptionGenerator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate 3 SEO-optimized meta descriptions (under 160 characters) for the following topic/content. Include a call to action. Content:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Meta Description Generator - OptiSEO Tools" description="AI-powered meta description generator." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Meta Description Generator</h1>
            <p className="text-gray-600 dark:text-gray-400">AI-powered meta description generator.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Page Content or Topic</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['meta-description-generator'] || [
