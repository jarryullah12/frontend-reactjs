...
export function AppStoreKeywordTool() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate ASO (App Store Optimization) keywords for the following app category or name. App:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="App Store Keyword Tool - OptiSEO Tools" description="Find keywords for App Store Optimization (ASO)." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">App Store Keyword Tool</h1>
            <p className="text-gray-600 dark:text-gray-400">Find keywords for App Store Optimization (ASO).</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">App Name or Category</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['app-store-keyword-tool'] || [
