...
export function IPLocationFinder() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate an IP location lookup for the following IP address. Provide a mock City, Country, and ISP. IP:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="IP Location Finder - OptiSEO Tools" description="Find the geographical location of an IP address." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">IP Location Finder</h1>
            <p className="text-gray-600 dark:text-gray-400">Find the geographical location of an IP address.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['ip-location-finder'] || [
