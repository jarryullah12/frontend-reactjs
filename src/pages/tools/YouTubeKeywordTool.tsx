...
export function YouTubeKeywordTool() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate a list of high-volume YouTube keywords and video ideas for the following topic. Topic:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="YouTube Keyword Tool - OptiSEO Tools" description="Find the best keywords for YouTube videos." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">YouTube Keyword Tool</h1>
            <p className="text-gray-600 dark:text-gray-400">Find the best keywords for YouTube videos.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Video Topic</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['youtube-keyword-tool'] || [
