    ...
    <>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">XML Sitemap Formatter</h1>
            <p className="text-gray-600 dark:text-gray-400">Format and beautify XML sitemaps.</p>
          </div>
