...
export function XMLSitemapFormatter() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Format the following URLs into a valid XML Sitemap structure. URLs:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="XML Sitemap Formatter - OptiSEO Tools" description="Format and beautify XML sitemaps." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12 text-center md:text-left">
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-4">XML Sitemap Formatter</h1>
        <p className="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl">Format and beautify XML sitemaps.</p>
          </div>
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-2xl p-6 rounded-2xl border border-white/50 dark:border-gray-700/50 shadow-xl dark:shadow-2xl dark:shadow-black/40 transition-all hover:shadow-2xl ">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Raw URLs or Messy Sitemap</label>
              <input
                type="text"
                ...
                placeholder="Enter URLs or Sitemap..."
                value={input}
        ...
        <ToolDescription points={toolDescriptions['xml-sitemap-formatter'] || [
