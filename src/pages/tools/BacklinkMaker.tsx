...
export function BacklinkMaker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate a list of potential backlink opportunities (directories, guest post ideas, resource pages) for the following URL/niche. URL:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Backlink Maker - OptiSEO Tools" description="Generate free backlinks to your website." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Backlink Maker</h1>
            <p className="text-gray-600 dark:text-gray-400">Generate free backlinks to your website.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['backlink-maker'] || [
