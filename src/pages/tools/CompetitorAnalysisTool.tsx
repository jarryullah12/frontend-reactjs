...
export function CompetitorAnalysisTool() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate a competitor SEO analysis for the following URLs based on their domain names and general industry knowledge. Compare their likely top keywords and backlink strategies. Do NOT provide generic on-page advice like "Add an H1 tag" or "Add a meta description" since you cannot see their actual page content. URLs:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Competitor Analysis Tool - OptiSEO Tools" description="Analyze competitor websites for SEO insights." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Competitor Analysis Tool</h1>
            <p className="text-gray-600 dark:text-gray-400">Analyze competitor websites for SEO insights.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Competitor URLs</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['competitor-analysis-tool'] || [
