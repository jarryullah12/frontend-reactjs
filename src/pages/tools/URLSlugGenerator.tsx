...
export function URLSlugGenerator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate 5 SEO-friendly URL slugs for the following post title. Title:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="URL Slug Generator - OptiSEO Tools" description="Generate SEO-friendly URL slugs." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">URL Slug Generator</h1>
            <p className="text-gray-600 dark:text-gray-400">Generate SEO-friendly URL slugs.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['url-slug-generator'] || [
