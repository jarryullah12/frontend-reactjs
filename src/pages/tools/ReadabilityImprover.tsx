...
export function ReadabilityImprover() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Improve the readability of the following text. Make it easier to read (aim for an 8th-grade reading level) while keeping the original meaning. Text:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Readability Improver - OptiSEO Tools" description="Improve the readability score of your content." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Readability Improver</h1>
            <p className="text-gray-600 dark:text-gray-400">Improve the readability score of your content.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Text to Improve</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['readability-improver'] || [
