...
export function SafeBrowsingChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a Google Safe Browsing check for the following URL. Provide a mock status (Safe/Unsafe) and explain what it means. URL:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Safe Browsing Checker - OptiSEO Tools" description="Check if a website is safe according to Google." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Safe Browsing Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check if a website is safe according to Google.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['safe-browsing-checker'] || [
