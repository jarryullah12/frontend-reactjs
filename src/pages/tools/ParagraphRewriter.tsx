...
export function ParagraphRewriter() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Rewrite the following paragraph to be more engaging, clear, and SEO-friendly. Provide 3 different versions. Paragraph:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Paragraph Rewriter - OptiSEO Tools" description="Rewrite paragraphs for better readability and SEO." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Paragraph Rewriter</h1>
            <p className="text-gray-600 dark:text-gray-400">Rewrite paragraphs for better readability and SEO.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Paragraph to Rewrite</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['paragraph-rewriter'] || [
