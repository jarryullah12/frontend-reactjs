...
export function ServerPortScanner() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a server port scan for the following host. List common open ports (e.g., 80, 443, 22) and their status. Host:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Server Port Scanner - OptiSEO Tools" description="Scan open ports on a server." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Server Port Scanner</h1>
            <p className="text-gray-600 dark:text-gray-400">Scan open ports on a server.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['server-port-scanner'] || [
