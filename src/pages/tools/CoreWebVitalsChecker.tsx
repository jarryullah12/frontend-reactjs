...
export function CoreWebVitalsChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a Core Web Vitals check for the following URL. Provide mock scores for LCP, FID, and CLS, along with optimization tips. URL:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Core Web Vitals Checker - OptiSEO Tools" description="Check Core Web Vitals metrics." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Core Web Vitals Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check Core Web Vitals metrics.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['core-web-vitals-checker'] || [
