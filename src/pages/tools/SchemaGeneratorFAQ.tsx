...
export function SchemaGeneratorFAQ() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate FAQPage Schema.org JSON-LD markup for the following questions and answers. Input:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Schema Generator (FAQ) - OptiSEO Tools" description="Generate FAQ Schema markup for your pages." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Schema Generator (FAQ)</h1>
            <p className="text-gray-600 dark:text-gray-400">Generate FAQ Schema markup for your pages.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Questions and Answers</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['schema-generator-faq'] || [
