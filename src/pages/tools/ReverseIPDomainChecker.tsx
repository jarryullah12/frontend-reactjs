...
export function ReverseIPDomainChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a Reverse IP Domain check for the following input. List mock domains hosted on the same server. Input:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Reverse IP Domain Checker - OptiSEO Tools" description="Find other domains hosted on the same IP." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Reverse IP Domain Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Find other domains hosted on the same IP.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">IP Address or Domain</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['reverse-ip-domain-checker'] || [
