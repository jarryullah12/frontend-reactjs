...
export function BulkURLChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Perform a bulk SEO check for the following URLs. Since you cannot directly access them, provide an analysis based on the URL structure (e.g., readability, keywords, length) and suggest potential SEO improvements for each URL. Do NOT provide generic on-page advice like "Add an H1 tag" since you cannot see the page content. URLs:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Bulk URL Checker - OptiSEO Tools" description="Check the status codes of multiple URLs at once." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Bulk URL Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check the status codes of multiple URLs at once.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">URLs (one per line)</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['bulk-url-checker'] || [
