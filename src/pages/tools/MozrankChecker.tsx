...
export function MozrankChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a MozRank check for the following URL. Provide a mock MozRank score (0-10) and explain how to improve it. URL:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Mozrank Checker - OptiSEO Tools" description="Check the Mozrank of a website." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Mozrank Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check the Mozrank of a website.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['mozrank-checker'] || [
