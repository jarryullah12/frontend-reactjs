...
export function TitleTagGenerator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Generate 5 catchy and SEO-optimized title tags (under 60 characters) for the following topic/content. Content:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Title Tag Generator - OptiSEO Tools" description="AI-powered title tag generator." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Title Tag Generator</h1>
            <p className="text-gray-600 dark:text-gray-400">AI-powered title tag generator.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['title-tag-generator'] || [
