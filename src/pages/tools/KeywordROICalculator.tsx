...
export function KeywordROICalculator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Calculate the estimated ROI for a keyword with the following metrics: Search Volume, CTR, Conversion Rate, and Average Value per Conversion. Input:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Keyword ROI Calculator - OptiSEO Tools" description="Calculate the potential ROI of a keyword." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Keyword ROI Calculator</h1>
            <p className="text-gray-600 dark:text-gray-400">Calculate the potential ROI of a keyword.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Search Volume, CTR, Conv. Rate, Value</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['keyword-roi-calculator'] || [
