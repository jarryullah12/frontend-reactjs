...
export function HTTP2Checker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate an HTTP/2 support check for the following URL. Explain the benefits of HTTP/2 if it were enabled. URL:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="HTTP/2 Checker - OptiSEO Tools" description="Check if a website supports HTTP/2." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">HTTP/2 Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check if a website supports HTTP/2.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['http2-checker'] || [
