...
export function CSSValidator() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Perform a CSS validation check for the following input. Point out actual CSS syntax errors and optimization tips. Do NOT provide generic SEO advice like "Add an H1 tag" or "Add a meta description". Focus strictly on CSS validation. Input:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="CSS Validator - OptiSEO Tools" description="Validate CSS code for errors." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">CSS Validator</h1>
            <p className="text-gray-600 dark:text-gray-400">Validate CSS code for errors.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">CSS Code or URL</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['css-validator'] || [
