...
export function EmailPrivacyChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate an email privacy check. Scan the following input for exposed email addresses and suggest obfuscation methods. Input:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Email Privacy Checker - OptiSEO Tools" description="Check if a webpage exposes email addresses." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Email Privacy Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check if a webpage exposes email addresses.</p>
          </div>
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Website URL or Text</label>
              <textarea
        ...
        <ToolDescription points={toolDescriptions['email-privacy-checker'] || [
