...
export function DomainAgeChecker() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Simulate a domain age check for the following domain. Provide a mock creation date and age in years/months. Domain:\n${input}`,
      });
  ...
  return (
    <>
      <SEO title="Domain Age Checker - OptiSEO Tools" description="Check the age of a domain." />
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Domain Age Checker</h1>
            <p className="text-gray-600 dark:text-gray-400">Check the age of a domain.</p>
          </div>
        ...
        <ToolDescription points={toolDescriptions['domain-age-checker'] || [
