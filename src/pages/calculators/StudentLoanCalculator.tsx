  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Estimate your monthly student loan payments." />
      </Helmet>
      <CalculatorWrapper
        title="Student Loan Calculator"
        description="Estimate your monthly student loan payments and total cost of borrowing."
      >
