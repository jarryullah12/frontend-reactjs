...
export function Pricing() {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: prices['1469064']?.price || 4,
      currency: prices['1469064']?.formatted ? '' : '$',
      formattedPrice: prices['1469064']?.formatted || '4',
      period: '/month',
      features: [
        { name: '50 Free SEO Tools', included: true },
        { name: '100+ Premium SEO Tools', included: false },
    ...
    },
    {
      ...
      price: prices['1469062']?.price || 8,
      currency: prices['1469062']?.formatted ? '' : '$',
      formattedPrice: prices['1469062']?.formatted || '8',
      period: '/month',
      features: [
        { name: '50 Free SEO Tools', included: true },
    ...
    },
    {
      ...
      price: prices['1436021']?.price || 100,
      currency: prices['1436021']?.formatted ? '' : '$',
      formattedPrice: prices['1436021']?.formatted || '100',
      period: '',
      features: [
        { name: '50 Free SEO Tools', included: true },
        { name: '100+ Premium SEO Tools', included: true },
